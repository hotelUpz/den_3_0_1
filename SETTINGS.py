...
class SETTINGSS():
    ...
    def init_main_settings(self):
        ...
        self.kline_time, self.time_frame = 5, 'h' # таймфрейм где челое число - период, а буква - сам тайм фрейм (минута, час и т.д (m, h))
        ...
        self.SLICE_VOLATILITY = 70 # срез волатильности. То есть первые 40 самых волатильных
