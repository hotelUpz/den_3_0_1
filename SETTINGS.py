...
class SETTINGSS():
    ...
    def init_main_settings(self):
        ...
        # 7 - 'trading_view_ind' # индикатор трейдинг вью
        # 8 - 'trading_view_ind + trend_line' # индикатор трейдинг вью + ориентироваться на линию тренда
        ...
        self.TOP_MARKET_CUP = 50 # срез монет. по коин маркет кап это будет первая тридцатка
