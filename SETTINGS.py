...
class SETTINGSS():
    ...
    def init_main_settings(self):
        ...
        self.stop_loss_ratio_mode = 8 # Метод для расчета коэффициента стоп-лосса. В интерфейсе телеграм бота -- соответсвующий номер стратегии. По умолчанию равен 1 (статический коэффициент, равный установленному значению. Сейчас стоит 1 % (в процентах) -- смотри ниже, а так же смотри инструкцию внизу страницы
        self.static_stop_loss_ratio_val = 0.5 # в % Множитель стоп лосса. Для статического стоп лосс коэффициента
        self.min_default_ratio = 0.75 # в %. минимальное дефолтное значение коэффициента стоп лосса к которому сбрасываются значение стоп лосс коэффициента если расчетные значения слишком малы. В %
        self.max_default_ratio = 3.5 # в % максимальное дефолтное значение коэффициента стоп лосса
        # ///////////////////////////////////
        # /////////////////////////////////////////////////////////////
        ...
        self.default_black_coins_list = self.black_coins_list = ['BTCUSDT', 'ETHUSDT', 'SOLUSDT', 'UNIUSDT'] # монеты исключения. Например ['shitokusdt', 'shitok2usdt']
