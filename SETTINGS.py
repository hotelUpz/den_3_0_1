...
class SETTINGSS():
    def __init__(self) -> None:
        ...
        self.default_reverse_signal = self.is_reverse_signal = 1 # Вкл/Выкл: -1/1 # использовать обратный сигнал. Если шорт то лонг и наоборот. Чтобы активировать введите значение -1 (минус один)
        self.is_reverse_defencive_mehanizm = 1 # Вкл/Выкл: 1/0 -- применять антистратегию в случае неудачной сделки
        ...
        self.risk_reward_ratio = '1:1.2'  # соотношение риска к прибыли.
        ...
        self.classikal_martin_gale = 1 # классический мартин гейл
        ...
        self.max_martin_gale_counter = 2 # сколько раз умножать позицию. При self.max_martin_gale_counter_auto_true = 1 расчитает этот счетчик автоматически
        ...
        self.is_proxies_true = 0 # Использовать прокси/не использовать (1/0)