...
class SETTINGSS():
    ...
    def init_main_settings(self):
        ...
        self.risk_reward_ratio = '1:2'  # соотношение риска к прибыли. только для 'FIXED или для'SIGNAL_ADVANCED'
        ...
        self.static_stop_loss_ratio_val = 1 # в % Множитель стоп лосса. Для статического стоп лосс коэффициента
